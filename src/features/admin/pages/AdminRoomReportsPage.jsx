        ...
        <Container maxWidth="xl" sx={{ py: 4 }} className="admin-page">
            ...
            >
                ...
                >
                    ...
                    <Box sx={{ textAlign: "right" }}>
                        <Typography variant="caption" sx={{ display: "block", opacity: 0.7, fontWeight: 700 }}>
                            SESSION REFERENCE
                        </Typography>
                        <Typography sx={{ fontFamily: "monospace", fontSize: "14px", fontWeight: 700 }}>
                            {selectedRoomId}
                        </Typography>
                    </Box>
                </DialogTitle>
                                    ...
                                    {auditLogs.length > 0 ? (
                                        auditLogs.map((log) => {
                                            const getEventStyle = (type) => {
                                                switch (type) {
                                                    case 0:
                                                        return { icon: "🚪", label: "JOIN", color: "#10B981" };
                                                    case 1:
                                                        return { icon: "🏃", label: "LEAVE", color: "#F59E0B" };
                                                    case 2:
                                                        return { icon: "⚠️", label: "DISCONNECT", color: "#EF4444" };
                                                    case 3:
                                                        return { icon: "⚡", label: "CODE", color: "#3B82F6" };
                                                    case 4:
                                                        return { icon: "🌐", label: "LANG", color: "#6366F1" };
                                                    case 5:
                                                        return { icon: "📝", label: "PROB", color: "#8B5CF6" };
                                                    case 6:
                                                        return { icon: "📷", label: "CAM", color: "#EC4899" };
                                                    case 7:
                                                        return { icon: "🎙️", label: "MIC", color: "#06B6D4" };
                                                    case 8:
                                                        return { icon: "🚨", label: "REPORT", color: "#F43F5E" };
                                                    default:
                                                        return { icon: "🔔", label: "EVENT", color: "#64748B" };
                                                }
                                            };
            ...
            >
                ...
                <DialogActions sx={{ p: 3 }}>
                    ...
                    <PrimaryButton
                        loading={isResolving}
                        onClick={() =>
                            handleResolveReport(selectedReportId || actionMenuRow?.id, 1, refundOption, adminNote)
                        }
                        sx={{ px: 4 }}
                    >
                        Confirm & Resolve
            ...
            <ActionMenu anchorEl={actionMenuAnchor} open={Boolean(actionMenuAnchor)} onClose={handleCloseMenu}>
                ...
                >
                    ...
                    <ListItemText primary="Audit Logs" primaryTypographyProps={{ fontSize: "13px", fontWeight: 600 }} />
                </MenuItem>
                <MenuItem
