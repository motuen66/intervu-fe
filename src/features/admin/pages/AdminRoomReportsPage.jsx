                                                ...
                                                <TableRow key={log.id} sx={{ '&:hover': { bgcolor: 'action.hover' } }}>
                                                    ...
                                                    <TableCell>
                                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                            <Box sx={{ width: 32, height: 32, borderRadius: '50%', bgcolor: 'action.hover', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid', borderColor: 'divider' }}>
                                                                <Typography sx={{ fontSize: '12px', fontWeight: 700, color: 'text.secondary' }}>{(log.userName || 'S').charAt(0)}</Typography>
                                                            </Box>
                                                            <Typography sx={{ fontSize: '13px', color: 'text.primary', fontWeight: 700 }}>{log.userName || "System"}</Typography>
                                                        </Box>
                                                    </TableCell>
