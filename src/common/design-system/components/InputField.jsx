...
export function InputField({ id, label, hint, error, required, disabled, className = '', ...props }) {
  ...
  return (
    <div className={classes}>
      ...
      <input id={fieldId} className="claude-field__input" disabled={disabled} aria-invalid={!!error} aria-describedby={error ? `${fieldId}-error` : hint ? `${fieldId}-hint` : undefined} {...props} />
